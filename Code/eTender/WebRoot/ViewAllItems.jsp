...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  <br/>
	...
	<tr>
        ...
        <th><div align="center" class="Title">ItemName</div></th>
        <th><div align="center" class="Title">ItemType</div></th>
		   ...
		   %>
		    <tr bgcolor="#CEC9FA">
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%if (session.getAttribute("role").equals("admin")){ %><a href="UpdateItem.jsp?ItemID=<%=aItem.getItemID()%>"><%}%><%=aItem.getItemID()%></a></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aItem.getItemName()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aItem.getItemType()%></span></div></td>
     ...
     <%}
      ...
      {%>
         <tr><td height="24" colspan="6"><div align="center" class="style7"><strong>No Items Available</strong></div></td>
         </tr>
      <%
      }
       ...
       %>
       <%if (session.getAttribute("role").equals("admin")){ %>
         <tr><td height="24" colspan="6"><div align="center" class="style7"><strong><a href="AddItem.jsp">AddItem</a></strong></div></td></tr>
     <%} %>
