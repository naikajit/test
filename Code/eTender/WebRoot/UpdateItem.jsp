...
<!-- options --></TD>
  ...
  <TR>
    <TD>
    <br><br><br><br>	
    <form action="./UpdateItemAction" method="post" name="f" onSubmit="return checkban()">
             ...
             <td><table  border="0" width="530" height="152">
                   ...
                   <center> <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Update Item </h2>
                     <% if(request.getParameter("status")!=null)
                      ...
                      int itemNo=Integer.parseInt(request.getParameter("ItemID"));
                        Item aItem=new ItemDAO().getItem(itemNo);
               ...
               <br>
                   <input type="hidden" name="ItemID" value="<%=itemNo%>">
                     <td >ItemName</td>
                      <td ><input type="text" name="ItemName" value="<%=aItem.getItemName() %>"/>                      </td>
                      </tr>
                   ...
                   <tr>
    <td>Item Type</td>
    <td><select name="Itemtype" onChange="cleartext()">
   	   <option value="<%=aItem.getItemType()%>"><%=aItem.getItemType()%>
      ...
      <option  value="Non-Electronic">Non-Electronic</option>
                     ...
                     <td colspan="2">
                       <div align="center">
                         <input type="submit" name="Submit" value="UpdateItem"/>
                         </div>                        </td>
                      </tr>
                 </table></td>
