<%@page import="com.dts.etender.model.Profile"%> 
<%@page import="java.util.Enumeration,com.dts.core.util.CoreHash"%>
<%@page import="com.dts.etender.dao.ProfileDAO,com.dts.core.util.DateWrapper"%>
...
<BODY><TABLE cellSpacing=0 cellPadding=0 width="906" align=center border=0 bgcolor='cray' height="485">
  ...
  <TR>
    <TD>
    <br><br><br><br>	
    <form action="./SupplierAction" method="post" name="suppliers" onSubmit="">
             ...
             <td><table  border="0" width="530" height="152">
               ...
               <tr>
                 ...
                 <td><table border="0" align="center" bgcolor="#CCCCCC"  width="270">
                   ...
                   <center> <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Suppliers RegForm </h2>
               ...
               <br>
                     ...
                     <tr> <td >Company Name</td>
                      ...
                      <tr> <td >House no</td>
                      <td ><input type="text" name="hno">  </td>   </tr>
                  ...
                  <tr> <td >State</td>
                   ...
                   <tr> <td >Country</td>
                      ...
                      <option>-seelct-</option>
                       <option  value="India">Indain</option>
                  ...
                  <tr> <td >Phone No</td>
                    ...
                    <tr> <td >Fax</td>
                      ...
                      <td ><input type="text" name="email">  </td>   </tr>
                       ...
                       <tr> <td >Year of Est.</td>
                       <td><input type="text" name="year">
                      </td>   </tr>
                      
                        <tr> <td >Type Of Company</td>
                      <td ><select name="typeofcompany">
                      <option>-seelct-</option>
                    ...
                    <tr> <td >Item Manufacturer</td>
                      <td ><input type="text" name="itemmanu">  </td>   </tr>
                      
                  <tr> <td >Comapny Turnover</td>
                      <td ><input type="text" name="turnover">  </td>   </tr>
                      
                   <tr> <td >Cheif Executive</td>
                      <td ><input type="text" name="chiefexe">  </td>   </tr>
                      
                  <tr> <td >Document File</td>
                      <td ><input type="file" name="doc">  </td>   </tr>
                      
                   
                  
                 <tr>
    <td><pre><span class=Title> Registerd Date</span></pre></td>
    <td>
   <input type="text" name="reg" value="" size="20" /><a href="javascript:show_calendar('document.suppliers.reg', document.suppliers.reg.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>    </td>
  </tr>
                      
                     
                     
                       <tr> <td >Major Customer</td>
