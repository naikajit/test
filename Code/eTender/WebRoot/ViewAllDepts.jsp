<%@page import="com.dts.etender.model.Department"%> 
...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  <br/>
	...
	<tr>
         	...
         	<tr bgcolor="#CCCCCC">
        <th><div align="center" class="Title">DepartmentID</div></th>
        <th><div align="center" class="Title">DepartmentName</div></th>
        <th><div align="center" class="Title">DepartmentAbbrivation</div></th>
        <th><div align="center" class="Title">DepartmentIncharge</div></th>
		   ...
		   String loginid=new ProfileDAO().getUserID(aDept.getDepartmentInChgID());
		   %>
		    <tr bgcolor="#CEC9FA">
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%if (session.getAttribute("role").equals("admin")){ %><a href="UpdateDept.jsp?deptNo=<%=aDept.getDepartmentID()%>"><%}%><%=aDept.getDepartmentID()%></a></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aDept.getDepartmentName()%></span></div></td>
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=aDept.getDepartmentAbbr()%></span></div></td>
     ...
     <%}
      ...
      {%>
         <tr><td height="24" colspan="6"><div align="center" class="style7"><strong>No Departments Available</strong></div></td>
         </tr>
      <%
      }
       ...
       %>
       <%if (session.getAttribute("role").equals("admin")){ %>
         <tr><td height="24" colspan="6"><div align="center" class="style7"><strong><a href="AddDept.jsp">AddDepartment</a></strong></div></td></tr>
     <%} %>
