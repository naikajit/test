...
<!-- options --></TD>
  ...
  <TR>
    <TD>
    <br><br><br><br>	
    <form action="./" method="post" name="quatationpost" onSubmit="">
             ...
             <td><table  border="0" width="530" height="152">
               ...
               <br>
                    ...
                    <tr> <td >Supplier Name</td>
                     ...
                     <tr> <td >DDNo</td>
                      <td ><input type="text "  name="ddno">   </td>   </tr>
                      
                      
                  
                  
                 <tr>
    <td><pre><span class=Title> Bid Posting Date</span></pre></td>
    <td>
   <input type="text" name="bpod" value="" size="20" /><a href="javascript:show_calendar('document.quatationpost.bpod', document.quatationpost.bpod.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>    </td>
  </tr>
                      
                     
                     
                       <tr> <td >Quantity</td>
                      <td ><input type="text"  name="quant ">   </td>   </tr>
                       
                      
                        <tr> <td >Specification</td>
                      <td ><input type="text"  name="specifc ">   </td>   </tr>
