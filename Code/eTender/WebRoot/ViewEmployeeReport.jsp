...
report+="<br/><br/><tr><strong><span class='style16'><u> All Employees Report<br/><br/></u></span></strong></tr><tr>";
report+="<th bgcolor='skyblue'><div align='center' class='style16'>LoginID</div></th>";
   report+=" <th bgcolor='skyblue'><div align='center' class='style16'>FirstName</div></th>";
    report+="<th bgcolor='skyblue'><div align='center' class='style16'>LastName</div></th>";
    report+=" <th bgcolor='skyblue'><div align='center' class='style16'>DOB</div></th>";
    ...
    report+="<th bgcolor='skyblue'><div align='center' class='style16'>Photograph</div></th>";
...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  ...
  int sno=1;
		  String path=request.getRealPath("/userimages");
		   ...
		   if(aProfile.getPassportStatus()==0)
		    passstatus="No Passport";
		    else
		    passstatus="Obtained";
...
report+="    <td bgcolor='#EFFEFF'><div align='center' class='style16'>"+aProfile.getBirthDate() +"</div></td>";
 report+="   <td bgcolor='#EFFEFF'><div align='center' class='style16'>"+aProfile.getPhone() +"</div></td>";
 report+="   <td bgcolor='#EFFEFF'><div align='center' class='style16'>"+aProfile.getEmail() +"</div></td>";
report+="<td bgcolor='#EFFEFF'><div align='center' class='style16'><img alt='See Photo Here' id='previewField' src='userimages/"+aProfile.getLoginID()+".gif' height='25' width='22'></div></td>";  
