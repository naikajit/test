<%@page import="com.dts.etender.model.Profile,com.dts.etender.model.Department"%> 
<%@page import="java.util.Enumeration,com.dts.core.util.CoreHash"%>
<%@page import="com.dts.etender.dao.ProfileDAO,com.dts.etender.dao.DepartmentDAO,com.dts.core.util.DateWrapper"%>
...
window.location.href='http://'+host+':'+port+'/eTender/ChekUserAction?userName='+userName;
...
<script language="JavaScript" src="images/pop-closeup.js"></script>
      	...
      	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	       ...
	       <h3><div align="center"><strong><span class="subHead"><br>Register Form </span></strong></div></h3>
<form action="./RegisterAction" method="post" name="register">
 <!--<table border="1"><tr><td></td></tr></table>-->
 <strong><input type="hidden" name="port" value="<%=request.getLocalPort() %>"> 
...
<tr></tr><tr></tr>
 <tr>
    <td><pre><span class=Title>    EmpLoginID</span></pre></td>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class=Title><%if(request.getParameter("status1")!=null)
                                                                                                              out.print(request.getParameter("status1"));    %></span></td>
</tr>
<tr>
...
<tr>
    <td><pre><span class=Title>    Desingnation</span></pre></td>
    <td><select name="Desingation" onChange="cleartext()">
    <option value="select" selected="true"><font size="3" face="Verdana">--Select-- </font></option>
    <option value="admin"><font size="3" face="Verdana">Administrator</font></option>
    <option value="employee"><font size="3" face="Verdana">Employee</font></option>
    
      </select></td>
</tr>
<tr>
    <td><pre><span class=Title>    DepartmentID</span></pre></td>
    <td><select name="DepartmentID" onChange="cleartext()">
    <option value="select" selected="true"><font size="3" face="Verdana">--Select-- </font></option>
    <%
            CoreHash aCoreHash=new DepartmentDAO().getDeptatments();
		   
		   Enumeration e=aCoreHash.keys();
		   while(e.hasMoreElements())
		   {
		   Integer i=(Integer)e.nextElement();
		   Department aDept=(Department)aCoreHash.get(i);
		   
		   %>
		   <option value="<%=aDept.getDepartmentID()%>"><font size="3" face="Verdana"><%=aDept.getDepartmentName() %></font></option>
		   <%} %>
      </select></td>
</tr>
<tr></tr><tr></tr>
...
<tr><td></td>
    ...
    <pre> <input type="submit" value="Register"/>&nbsp;  <input type="reset" name="cancel" value="Cancel"/>
   </pre> </font></td>
    <td align="center"></td>
</tr>
</table>
...
<tr>
 <img alt="See Photo Here" id="previewField" src="images/girl.jpg" height="150" width="120">
  ...
  <tr>
    <td><pre><span class=Title>   Phone No</span></td>
