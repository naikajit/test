...
<!-- options --></TD>
  ...
  <TR>
    ...
    <form action="./QuatationTenderAction" method="post" name="tenderpost" onSubmit="">
             ...
             <td><table  border="0" width="530" height="152">
               ...
               <tr>
                 ...
                 <td><table border="0" align="center" bgcolor="#CCCCCC"  width="270">
                   ...
                   <center> <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TenterQuatation Form </h2></center>
                         
                    
                     <tr> <td >Supplier Name</td>
                      <td ><input type="text "  name="SuppName">   </td>   </tr>
                     ...
                     <td colspan="2">
                       <div align="center">
                         <input type="submit" name="Submit" value="PostQuatation"/>
                          &nbsp;
