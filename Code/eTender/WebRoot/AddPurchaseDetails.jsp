...
<!-- options --></TD>
  ...
  <TR>
    <TD>
    <br><br><br><br>	
    <form action="./" method="post" name="purchase" onSubmit="">
    ...
    <td>
   <input type="text" name="pod" value="" size="20" /><a href="javascript:show_calendar('document.purchase.pod', document.purchase.pod.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>    </td>
  </tr>
                      
                      <tr>
    <td><pre><span class=Title>  Receipt Date</span></pre></td>
    <td>
   <input type="text" name="dor" value="" size="20" readonly="readonly" /><a href="javascript:show_calendar('document.purchase.dor', document.purchase.dor.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a>    </td>
  </tr>
                      
                      
                      <tr> <td >PriceBid</td>
                      <td ><input type="text" name="pricebid">   </td> </tr>
                  ...
                  <TR>
                     <td colspan="2">
                       <div align="center">
                         <input type="submit" name="Submit" value="AddPurchase"/>
                          &nbsp;
