...
<!-- options --></TD>
  ...
  <TR>
    <TD>
    <br><br><br><br>	
    <form action="./UpdateDeptAction" method="post" name="f" onSubmit="return checkban()">
             ...
             <td><table  border="0" width="530" height="152">
               ...
               <tr>
                 ...
                 <td><table border="0" align="center" bgcolor="#CCCCCC"  width="270">
                   ...
                   <center> <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Update Department </h2>
                     <% if(request.getParameter("status")!=null)
					  {%>
                           <strong><%=request.getParameter("status")%></strong>
                      <%}
                      int deptno=Integer.parseInt(request.getParameter("deptNo"));
                        Department aDept=new DepartmentDAO().getDeptatment(deptno);
               ...
               <br>
                   <input type="hidden" name="deptno" value="<%=deptno%>">
                     <td >DeptName</td>
                      <td ><input type="text" name="DeptName" value="<%=aDept.getDepartmentName() %>"/>                      </td>
                      </tr>
                     
                   <tr>
                     <td>DeptAbrrivation</td>
                      <td>
                        <input type="text" name="DeptAbbr" value="<%=aDept.getDepartmentAbbr() %>"/>                      </td>
                      </tr>
                   <tr>
                   <tr>
    <td>InchargeID</td>
    <td><select name="EmpID" onChange="cleartext()">
   
    <%
            CoreHash aCoreHash=new ProfileDAO().getAdmins();
		   ...
		   %>
		   <option value="<%=aProfile.getEmpid()%>"><font size="3" face="Verdana"><%=aProfile.getLoginID() %></font></option>
		   <%} %>
      </select></td>
</tr><TR>
                     <td colspan="2">
                       <div align="center">
                         <input type="submit" name="Submit" value="UpdateDept"/>
                         </div>                        </td>
                      </tr>
                 </table></td>
