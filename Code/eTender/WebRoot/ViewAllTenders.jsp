...
<table border="1" align="center" bordercolor="wheat" bgcolor="#FFFFFF" width="719" height="20%">
  <br/>
    ...
    <%
            CoreHash aCoreHash=new TenderPostDAO().getAllTenderPostsDate();
	...
	<tr>
        ...
        <th><div align="center" class="Title">Quaantity</div></th>
        ...
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><a href='QuatationTender.jsp?tenderID=<%=aTenderPost.getTenderid() %>'>Quate the Tender</a>
      </tr>
     <%}
      }
      else 
      {%>
         <tr><td height="24" colspan="6"><div align="center" class="style7"><strong>No Tenders Available</strong></div></td>
         </tr>
      <%
      }
